...
import com.teragrep.k8s_01.metadata.NamespaceMetadataContainerImpl;
import com.teragrep.k8s_01.metadata.PodMetadataContainer;
import com.teragrep.k8s_01.metadata.PodMetadataContainerImpl;
...
class KubernetesCachingAPIClientImpl implements KubernetesCachingAPIClient {
    private static final Logger LOGGER = LoggerFactory.getLogger(KubernetesCachingAPIClientImpl.class);
    ...
    KubernetesCachingAPIClientImpl(AppConfigKubernetes appConfigKubernetes, String apiUrl) throws IOException {
    ...
    private NamespaceMetadataContainer fetchNamespace(String namespace) throws ApiException {
        ...
        return new NamespaceMetadataContainerImpl(api.readNamespace(namespace, null));
    }
}
